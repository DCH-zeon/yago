...
import (
	...
	_ "github.com/dch-zeon/yago/api/docs"
	...
	"github.com/dch-zeon/yago/internal/migrate"
	"github.com/dch-zeon/yago/internal/server"
)

// @title YAGO REST API
// @version 1.0
// @description YAGO REST API e-commerce in Go with JWT authentication

// @contact.name API Support
// @contact.url https://dch-zeon.github.io/yago-docs/

// @host https://api.yago.loc
// @BasePath /
...
func run() error {
	logger := slog.Default()
	logger.Info("Starting YAGO REST API ...")
	...
	router := server.SetupRouter(customerHandler, authService, cfg, database)
