...
export default function UserEdit({ user, roles, userRoles }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Редагування користувача: ${user.name}`} />

            <div className="space-y-4 p-4">
                <Heading
                    title={`Редагування користувача: ${user.name}`}
                    description="Оновіть дані користувача та його ролі"
                />
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="password">Пароль (залиште порожнім, щоб не змінювати)</Label>
